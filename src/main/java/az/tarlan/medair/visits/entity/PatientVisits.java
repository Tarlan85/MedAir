...
public class PatientVisits {
    ...
    public PatientVisits(int visitId, int patientId, Timestamp visitDate, String visitReason, String status, String placeName, String visitType, String visitDesc) {
